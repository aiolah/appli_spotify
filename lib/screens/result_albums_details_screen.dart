...
/// The details screen
class ResultAlbumsScreen extends StatefulWidget {
  String? idAlbum;

  /// Constructs a [ResultAlbumsScreen]
  ResultAlbumsScreen({super.key, this.idAlbum});

  @override
  State<ResultAlbumsScreen> createState() => _ResultAlbumsScreen();
}

class _ResultAlbumsScreen extends State<ResultAlbumsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('Search Album Details Screen')),
